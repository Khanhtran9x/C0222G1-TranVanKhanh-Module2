...
public class ProductManager {
    ...
    public static void addProduct(LinkedList<Product> productArr){
    ...
    public static void editProductById(LinkedList<Product> productArr){
        Scanner scanner = new Scanner(System.in);
    ...
    public static void removeProductById(LinkedList<Product> productArr) {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void displayProductList(LinkedList<Product> productArr){
        for (Product product: productArr) {
            System.out.println(product.toString());
        }
    }

    public static void findProductByName(LinkedList<Product> productArr){
        Scanner scanner = new Scanner(System.in);
    ...
    public static void sortProductByPrice(LinkedList<Product> productArr){
        Scanner scanner = new Scanner(System.in);
